...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon10 = QtGui.QIcon()
        icon10.addPixmap(QtGui.QPixmap("icons/password32px.ico"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.act_chgpwd.setIcon(icon10)
        self.act_chgpwd.setObjectName("act_chgpwd")
        self.act_chguser = QtWidgets.QAction(MainWindow)
        icon11 = QtGui.QIcon()
        icon11.addPixmap(QtGui.QPixmap("icons/user32px.ico"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.act_chguser.setIcon(icon11)
        self.act_chguser.setObjectName("act_chguser")
        self.act_quit = QtWidgets.QAction(MainWindow)
        icon12 = QtGui.QIcon()
        icon12.addPixmap(QtGui.QPixmap("icons/quit128px.ico"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.act_quit.setIcon(icon12)
