...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap("icons/gps_navigation_32px.ico"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.tabWidget.addTab(self.tab_following, icon9, "")
        ...
        icon10 = QtGui.QIcon()
        icon10.addPixmap(QtGui.QPixmap("icons/excel_128px.ico"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.btn_to_excel.setIcon(icon10)
        ...
        icon11 = QtGui.QIcon()
        icon11.addPixmap(QtGui.QPixmap("icons/bar.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.btn_to_spc.setIcon(icon11)
        ...
        icon12 = QtGui.QIcon()
        icon12.addPixmap(QtGui.QPixmap("icons/password32px.ico"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.act_chgpwd.setIcon(icon12)
        self.act_chgpwd.setObjectName("act_chgpwd")
        self.act_chguser = QtWidgets.QAction(MainWindow)
        icon13 = QtGui.QIcon()
        icon13.addPixmap(QtGui.QPixmap("icons/user32px.ico"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.act_chguser.setIcon(icon13)
        self.act_chguser.setObjectName("act_chguser")
        self.act_quit = QtWidgets.QAction(MainWindow)
        icon14 = QtGui.QIcon()
        icon14.addPixmap(QtGui.QPixmap("icons/quit128px.ico"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.act_quit.setIcon(icon14)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.test_sch_key.setPlaceholderText(_translate("MainWindow", "批号或产品名称"))
