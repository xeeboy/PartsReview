...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap("icons/signature_128px.ico"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.btn_sign_pre.setIcon(icon5)
        ...
        self.btn_save_pre.setIcon(icon2)
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap("icons/find.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.tabWidget.addTab(self.tab_onpreving, icon6, "")
        ...
        self.follow_btn_search.setIcon(icon3)
        ...
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap("icons/gps_navigation_32px.ico"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.tabWidget.addTab(self.tab_following, icon7, "")
        ...
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap("icons/password32px.ico"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.act_chgpwd.setIcon(icon8)
        self.act_chgpwd.setObjectName("act_chgpwd")
        self.act_chguser = QtWidgets.QAction(MainWindow)
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap("icons/user32px.ico"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.act_chguser.setIcon(icon9)
        self.act_chguser.setObjectName("act_chguser")
        self.act_quit = QtWidgets.QAction(MainWindow)
        icon10 = QtGui.QIcon()
        icon10.addPixmap(QtGui.QPixmap("icons/quit128px.ico"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.act_quit.setIcon(icon10)
