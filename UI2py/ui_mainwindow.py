...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("icons/Quality_Control_72px.ico"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.frame_9 = QtWidgets.QFrame(self.tab_following)
        self.frame_9.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.frame_9.setFrameShadow(QtWidgets.QFrame.Raised)
        self.frame_9.setObjectName("frame_9")
        self.verticalLayout_12 = QtWidgets.QVBoxLayout(self.frame_9)
        self.verticalLayout_12.setObjectName("verticalLayout_12")
        self.rev_doc_title = QtWidgets.QLabel(self.frame_9)
        font = QtGui.QFont()
        font.setFamily("楷体")
        font.setPointSize(17)
        font.setUnderline(True)
        self.rev_doc_title.setFont(font)
        self.rev_doc_title.setAlignment(QtCore.Qt.AlignCenter)
        self.rev_doc_title.setObjectName("rev_doc_title")
        self.verticalLayout_12.addWidget(self.rev_doc_title)
        self.show_review_doc = QtWidgets.QTextBrowser(self.frame_9)
        self.show_review_doc.setFrameShape(QtWidgets.QFrame.Box)
        self.show_review_doc.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.show_review_doc.setLineWidth(1)
        self.show_review_doc.setMidLineWidth(1)
        self.show_review_doc.setOpenLinks(False)
        self.show_review_doc.setObjectName("show_review_doc")
        self.verticalLayout_12.addWidget(self.show_review_doc)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.rev_doc_title.setText(_translate("MainWindow", "不合格品处理详细信息"))
